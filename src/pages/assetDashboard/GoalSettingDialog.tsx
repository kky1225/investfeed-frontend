...
export default function GoalSettingDialog({open, onClose, onSaved, editGoal, existingTypes}: GoalSettingDialogProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setError(editGoal ? "목표 수정에 실패했습니다." : "이미 해당 유형의 목표가 존재합니다.");
        }
    };
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
            ...
            <DialogContent>
                <Box sx={{mt: 1, display: 'flex', flexDirection: 'column', gap: 2}}>
                    ...
                    <TextField
                        ...
                        onChange={(e) => setTargetAmount(e.target.value.replace(/,/g, '').replace(/[^0-9]/g, ''))}
            ...
            <DialogActions>
                ...
                <Button onClick={handleSubmit} disabled={!targetAmount}>{editGoal ? "수정" : "등록"}</Button>
            </DialogActions>
        </Dialog>
    );
}
