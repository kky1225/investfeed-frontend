...
import {updateManualHolding} from "../../api/broker/BrokerApi.ts";
import type {ManualHolding} from "../../type/BrokerType.ts";

interface EditManualHoldingDialogProps {
    open: boolean;
    onClose: () => void;
...
export default function EditManualHoldingDialog({open, onClose, holding, onUpdated}: EditManualHoldingDialogProps) {
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
            <DialogTitle>보유주식 수정</DialogTitle>
            <DialogContent>
