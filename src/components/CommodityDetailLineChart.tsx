...
export interface CommodityDetailLineChartProps {
    id: string,
    title: string,
    orderWarning: string,
    value: string,
...
const CommodityDetailLineChart = (
    { trend, seriesData = [], barDataList = [], dateList = [], height = 310 }: CommodityDetailLineChartProps,
) => {
...
export default CommodityDetailLineChart;